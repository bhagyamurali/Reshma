...
public class CSthree 
{
	...
	public void open_browser_again() throws Throwable 
	{
		driver = UtilityTest.openBrowser("Chrome");
		driver.get("http://10.232.237.143:443/TestMeApp/fetchcat.htm");
	...
	public void login_and_search_for_product_not_found() throws Throwable
	{
		...
		Assert.assertEquals("Home", driver.getTitle() );
		driver.findElement(By.xpath("//*[@id=\"myInput\"]")).click();
		driver.findElement(By.xpath("//*[@id=\"myInput\"]")).sendKeys("haihey");
		driver.findElement(By.xpath("/html/body/div[1]/form/input")).click();
	    Assert.assertEquals( "Search",driver.getTitle());
	...
	public void unsuccessfull_payment() throws Throwable
	{
	...
	public void login_and_no_search_for_product() throws Throwable {
		driver.findElement(By.xpath("//*[@id=\"header\"]/div[1]/div/div/div[2]/div/ul/li[1]/a")).click();	
		Assert.assertEquals("Login", driver.getTitle() );
		driver.findElement(By.xpath("//*[@id=\"userName\"]")).sendKeys("lalitha");
		driver.findElement(By.xpath("//*[@id=\"password\"]")).sendKeys("Password123");
